...
{
    /// <summary>
    /// Represents the CategoricalAxis for RadCartesianChart Silverlight control wrapper.
    /// </summary>
    public class CategoricalAxis : Control
    {
        ...
        /// <summary>
        /// Get the xaml tag of CategoricalAxis.
        /// </summary>
        public override string XamlTag
        {
            get
            {
                return MappingKeys.CategoricalAxisKey;
            }
        }
